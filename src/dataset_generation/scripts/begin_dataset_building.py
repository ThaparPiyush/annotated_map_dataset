...
class dataset:
    ...
    def do_stuff(self):
        for map_num in range (1,11): # Do the following with every map
            ...
            self.launch = roslaunch.parent.ROSLaunchParent(self.uuid, [self.global_plan_paths + '/test/node_test.launch']) #["/home/kanishk/ros_ws/wheelchair/src/dependencies/robot_navigation/dlux_plugins/test/node_test.launch"])
